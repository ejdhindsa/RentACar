...
public abstract class Vehicle implements Comparable<Vehicle>, Special
{
    ...
    public int specialCode;             // code for special cars
    ...
    /**********************************
     * This method sets the secialCode for the vehicle which comes in play when the
     * vehicle is added in the SpecialWeekly class
     * @rparam int - int value of the special code that is added
     ********************************/
    public void setSpecialCode(int specialCode)
    {
        this.specialCode = specialCode;
    } // end of setSpecialCode()
      
    /**********************************
     * The following method gets specialCode of the vehicle when it is added to the
     * weekly special class
     * @return int - specialCode of the vehicle
     ********************************/
    public int getSpecialCode()
    {
        return this.specialCode;
    } // end of getSpecialCode
